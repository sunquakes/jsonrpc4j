...
public class JsonRpcTcpClient5Test {
    ...
    public void testHandler() {
        // test tcp handler
        assertEquals(jsonRpcTcpClient5.add(1, 2), 3);
        assertEquals(jsonRpcTcpClient5.add(3, 4), 7);
        assertEquals(jsonRpcTcpClient5.add(5, 6), 11);
    }
